...
def normalize(probabilities):
    ...
    for person in probabilities.keys():
        ...
        probabilities[person]['gene'] = {genes: (probability / gene_sum) for genes, probability in
                                         probabilities[person]['gene'].items()}
        probabilities[person]['trait'] = {trait: (probability / trait_sum) for trait, probability in
